...
const ACTIONS = ["status", "diagnose", "audit", "trial_spec", "trial_results", "trial_review", "preflight", "prepare", "sections", "propose", "evaluate", "reflect", "observe", "review_observe", "clear_signals", "corpus", "preview", "mine", "reduce", "read", "list", "promote"];
const FIELDS = {
